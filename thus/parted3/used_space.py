...
def get_used_ntfs(part):
    ...
    try:
        ...
        result = None
        txt = _("Can't detect used space of NTFS partition {0}".format(part))
        logging.error(txt)
        logging.error(err)
...
def get_used_ext(part):
    ...
    try:
        ...
        result = None
        txt = _("Can't detect used space of EXTFS partition {0}".format(part))
        logging.error(txt)
        logging.error(err)
...
def get_used_fat(part):
    ...
    try:
        ...
        if b'Dirty bit is set' in err.output:
            ...
            result = None
            txt = _("Can't detect used space of FAT partition {0}".format(part))
            logging.error(txt)
            logging.error(err)
...
def get_used_jfs(part):
    ...
    try:
        ...
        result = None
        txt = _("Can't detect used space of JFS partition {0}".format(part))
        logging.error(txt)
        logging.error(err)
...
def get_used_reiser(part):
    ...
    try:
        ...
        result = None
        txt = _("Can't detect used space of REISERFS partition {0}".format(part))
        logging.error(txt)
        logging.error(err)
...
def get_used_btrfs(part):
    ...
    try:
        ...
        result = None
        txt = _("Can't detect used space of BTRFS partition {0}".format(part))
        logging.error(txt)
        logging.error(err)
...
def get_used_xfs(part):
    ...
    try:
        ...
        result = None
        txt = _("Can't detect used space of XFS partition {0}".format(part))
        logging.error(txt)
        logging.error(err)
