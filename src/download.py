...
if __name__ == '__main__':
    ...
    '''
    DownloadPackages(\
    ["manjaro-keyring", "manjaro-mirrorlist",
     ...
     "faenza-icon-theme", "manjaro-wallpapers", "unzip", "unrar", 
     "net-tools", "xf86-input-synaptics", "usb_modeswitch", "modemmanager"])
    '''
    
    '''
    DownloadPackages(\
    ["base", "base-devel", "manjaro-keyring", "manjaro-mirrorlist",
     "haveged", "crda", "ipw2200-fw", "ipw2100-fw", "zd1211-firmware",
     "wireless_tools", "wpa_actiond", "b43-fwcutter", "ntfs-3g", 
     ...
     "faenza-hotot-icon", "faenza-icon-theme", "manjaro-wallpapers",
